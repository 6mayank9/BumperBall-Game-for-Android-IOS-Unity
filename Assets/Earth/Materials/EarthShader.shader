Shader "Custom/EarthShader"
{
	...
	SubShader
	{
        ...
        */
			...
			fixed4 c;
			c.rgb = lerp(s.NightColor, (s.Albedo * _LightColor0.rgb * diffuseMultiplier) + (_LightColor0.rgb * spec * _SpecularPower), saturate(_NightTransitionVariable * diffuseMultiplier));
			c.a = s.Alpha;
